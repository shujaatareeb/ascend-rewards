...
export default {
  ...
  data: new SlashCommandBuilder()
    .setName("disablestock")
    .setDescription("Disable a package")
  ...
  async execute(interaction, client) {
    ...
    await interaction.reply({
      content: `❌ Package **${item.denomination}** disabled and shop updated.`,
      ephemeral: true
    });

    /* admin log */

    await logAdmin(client, "Stock Disabled", interaction.user, {
      Game: item.game,
